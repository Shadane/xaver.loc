...
foreach ($bd as $key => $value) { //цикл, который запускает обработку скидок для каждого наименования
     if ($bd[$key]['количество заказано']!=0){ //на случай, если появится кнопочка '-' у каждого товара в корзине)
   ...
   //у нас в этом смысла нет, но в жизни покупатель может заказать и 0
