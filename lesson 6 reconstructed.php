...
//конец блоков 
   ...
   }elseif (isset($_GET['formreturn'])) {        //если нажали на название обьявления, то заполняем массив $showform_params , если не нажали, то ранее заполнено по дефолту.
       
       $return_id = $_SESSION['ads'][$_GET['formreturn']];
       $showform_params = array(
